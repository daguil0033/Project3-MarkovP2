	...
	public void testMapMakeNgram() {
		...
		Assertions.assertAll("get random output",
			...
			()->assertTrue("This test checks if MarkovModel makes a correct " +
							   "Ngram using a simple source", randText.contains("aab")),
			()->assertTrue("This test checks if MarkovModel makes a correct " +
							   "Ngram using a simple source", randText.contains("baa")),
			()->assertTrue("This test checks if MarkovModel makes a correct " +
							   "Ngram using a simple source", randText.contains("abb")),
			()->assertTrue("This test checks if MarkovModel makes a correct " +
							   "Ngram using a simple source", randText.contains("bba")));
